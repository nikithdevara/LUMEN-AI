...
export default function AIAssistantCard({ title = 'AI Guide', children, className = '', onClose, streaming = false }) {
  return (
    <div className={cn(
      'relative overflow-hidden rounded-2xl border border-aiblue/20 bg-gradient-to-br from-aiblue/5 via-white/80 to-indigo-500/5 backdrop-blur-xl shadow-[0_8px_32px_rgba(59,130,246,0.08)]',
      className
    )}>
